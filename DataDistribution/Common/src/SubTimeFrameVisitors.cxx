...
SubTimeFrameReadoutBuilder::SubTimeFrameReadoutBuilder(const FairMQChannel& pChan)
  : mChan(pChan),
    mStf(nullptr)
{
}
...
std::unique_ptr<SubTimeFrame> InterleavedHdrDataDeserializer::deserialize(const FairMQChannel& pChan)
{
  int ret;
  // cleanup
  auto lCleanup = gsl::finally([this] {
